...
def _gerar_pdf_ofs(df: "pd.DataFrame") -> bytes:
    ...
    # Colunas a exibir e larguras (em mm)
    _COLS = [
        ("Nº OF",          16), ("NN°",           12), ("Cliente",        48),
        ("Abertura",       18), ("Prazo Entrega",  18), ("Nº Pedido",      20),
        ("Descrição Peça", 40), ("Liga",           14), ("Norma",          32),
        ("Qtd Pedido",     14), ("Qtd Fundida",    14), ("Qtd Expedida",   14),
        ("Vlr Total (R$)", 22), ("Nº OE",          22), ("Nº Certificado", 22),
    ]
