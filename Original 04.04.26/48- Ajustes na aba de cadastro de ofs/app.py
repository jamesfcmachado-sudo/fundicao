...
def pagina_nova_of() -> None:
    ...
    # Helper: selectbox que aceita texto livre.
    # Usa index=None para não pré-selecionar nada e allow o usuario digitar.
    # Se a opção digitada não estiver na lista, o Streamlit retorna None —
    # nesse caso lemos o valor do session_state do text_input interno.
    def _campo_ac(label, options, key):
        """Selectbox com allow digitação livre — aceita valor novo não listado."""
        return st.selectbox(
            label,
            options=options,
            index=None,
    ...
    with c1:
        ...
        nome_cliente = _campo_ac("Nome do Cliente * (▼)", _opts_cliente, "_of_cliente")
        ...
        numero_modelo  = _campo_ac("Número do modelo (▼)", _opts_modelo, "_of_modelo")
    with c2:
        descricao_peca = _campo_ac("Descrição da peça (▼)", _opts_descr,   "_of_descr")
        numero_desenho = _campo_ac("Número do desenho (▼)", _opts_desenho, "_of_desenho")
        ...
        liga           = _campo_ac("Liga (▼)",  _opts_liga,  "_of_liga")
        norma          = _campo_ac("Norma (▼)", _opts_norma, "_of_norma")
    ...
    # ── Lê valores — selectbox com index=None retorna o texto digitado ────
