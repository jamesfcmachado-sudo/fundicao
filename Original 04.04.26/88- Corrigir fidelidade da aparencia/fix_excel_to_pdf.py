...
OLD = '''                        from gerar_oe_excel import gerar_oe_pdf
...
NEW = '''                        from gerar_oe_excel import excel_para_pdf
...
if OLD in src:
    ...
    print("OK: Usando excel_para_pdf.")
else:
...
try:
    ...
    print("SINTAXE OK! Rode: git add . && git commit -m 'Converte Excel para PDF LibreOffice' && git push")
